                ...
                <div className='mt-2'>
                    ...
                    <ul className='text-xs text-gray-700 mt-1'>
                        {todoChecklist.map((item, index) => (
                            <li key={index} className={`flex items-center gap-1 ${item.completed ? 'line-through text-gray-500' : ''}`}>
                                <input type='checkbox' checked={item.completed} readOnly className='w-3 h-3' />
                                {item.text}
                            </li>
                        ))}
                    </ul>
